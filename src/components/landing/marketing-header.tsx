...
type MarketingPage = "product" | "workflow" | "pricing" | "teacher" | "about";
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border/10 bg-background/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 w-full max-w-[1440px] items-center justify-between gap-4 px-5 md:px-10">
        <Link
          className="flex min-w-0 items-center gap-3 rounded-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30"
          href="/"
        >
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold leading-5">AI Math Chat</p>
            <p className="truncate text-xs text-muted-foreground">Học toán, soạn bài, xuất file</p>
          </div>
        </Link>
